  ...
  return (
    <div id='skills' className='flex flex-col items-center justify-center sm:min-h-screen gap-8 sm:gap-20'>
      <div className='flex gap-3 items-center'>
        ...
        <p className='border border-blue-800 p-2 rounded-full font-normal text-sm text-blue-800 cursor-pointer hover:scale-105 h-fit whitespace-nowrap'>Bring your ideas to life!</p>
      </div>
